...
public class ApiLendItemController {
    ...
    @ApiOperation("会员投资数据提交")
    @PostMapping("/auth/commitInvest")
    public R commitInvest(@RequestBody InvestVO investVO, @RequestHeader(value = "token",required = false) String token) {
